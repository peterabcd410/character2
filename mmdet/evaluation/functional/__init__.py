...
from .class_names import (cityscapes_classes, coco_classes,coco_classes_six,
                          ...
                          oid_challenge_classes, oid_v6_classes, voc_classes,voc_classes_six)
...
__all__ = [
    'voc_classes', 'voc_classes_six','imagenet_det_classes', 'imagenet_vid_classes',
    'coco_classes', 'coco_classes_six','cityscapes_classes', 'dataset_aliases', 'get_classes',
